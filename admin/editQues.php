...
?>
<h3>Edit question:<?php echo $_GET['editQues']; ?></h3>
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
    <div class="form-row">
        <div class="form-group col-md-4">
            <input type="text" name="TestName" class="form-control" value="<?php echo $_GET['editQues']; ?>">
        </div>
        ...
        <input type="hidden" name="editTest" value="<?php echo $_GET['editQues']; ?>">
    </div>
    <div class="form-group">
        <input type="submit" class="btn btn-primary" name="editQues_btn" value="Submit">
